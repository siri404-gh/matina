const pictures = [
  ...
  {
    topic: 'Sathyavageeswarar temple',
  ...
  {
    topic: 'Santander cycles at Commercial Street',
  ...
  {
    topic: 'Christmas lights at Oxford Street',
